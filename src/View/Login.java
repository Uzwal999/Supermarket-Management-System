...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setFont(new java.awt.Font("Century Gothic", 3, 24)); // NOI18N
...
String username = jTextField1.getText().trim();
    ...
    // Requirement 5: Input validation and user-friendly error messages
    ...
    if (role.equals("Admin")) {
        ...
        // Loop through the static adminList to check credentials
        ...
        if (adminLoginSuccessful) {
            ...
            new AdminDashboard().setVisible(true); // Navigation to Admin Dashboard
            this.dispose();
        } else {
    ...
    // 3. Seller Login Logic
        ...
        // A. Check against the static list in your Seller class
        // This demonstrates MVC: The Controller (Login) accessing the Model (sellerList)
        for (Object[] seller : View.Seller.sellerList) {
            // Index 1 = Name/UID, Index 2 = Password (based on common Seller table structures)
            String sName = seller[1].toString(); 
            String sPass = seller[2].toString(); 
        ...
        // B. Hardcoded fallback for testing (can be removed later)
        if (!sellerFound && username.equals("seller") && password.equals("seller123")) {
            sellerFound = true;
        }

        if (sellerFound) {
            JOptionPane.showMessageDialog(this, "Seller Login Successful! Welcome " + username);
            new Products().setVisible(true); // Navigation to Products View
            this.dispose();
        } else {
            // Requirement 5: Error messages for invalid inputs
            JOptionPane.showMessageDialog(this, "Invalid Seller Credentials. Please contact Admin.");
        }
    }
// TODO add your handling code here:
